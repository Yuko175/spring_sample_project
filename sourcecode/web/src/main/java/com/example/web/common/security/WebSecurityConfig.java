...
public class WebSecurityConfig {
  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity http)
    ...
    return http
      ...
      // ログアウトの設定
      .logout(c -> c.logoutUrl("/logout") // ログアウトを行うパスを設定する
      )
      .authenticationManager(authenticationManager())
      .headers(c ->
        c.referrerPolicy(policy -> // https://developer.mozilla.org/ja/docs/Web/HTTP/Headers/Referrer-Policy // Referrer-Policyレスポンスヘッダの設定
