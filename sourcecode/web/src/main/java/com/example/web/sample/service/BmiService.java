...
public class BmiService {
  public BmiDto calcBmi(String height, String weight) {
    ...
    // 体裁整える
    BigDecimal adequateWeightDto = adequateWeight.stripTrailingZeros();
    BigDecimal comparisonDto = comparison.stripTrailingZeros();
    BigDecimal bmiDto = bmi.stripTrailingZeros();

    return new BmiDto(adequateWeightDto, comparisonDto, bmiDto);
  }
}
